...
<div id="encabezado">
    ...
    <p>Nezahualcóyotl, Estado de México a <?php echo date("d")?> de <?php echo date('m');?> de <?php echo date('Y');?>.</p>
</div>
<div id="body">
    <h5>DEPARTAMENTO DE ACTIVIDADES CULTURALES</h5>
    <h5>PRESENTE</h5>
    <p> Por medio de la misma, me presento como estudiante de la Universidad Nacional Autónoma de México, como: De la Facultad: de la carrera de: Número de cuenta:  De:  semestre.</p>
