    ...
    foreach ($talleres as $sem_talleres) {
        ...
        <div data-event="0" class="dragg_div" data-id="<?php echo $sem_talleres['id'] ?>">
            ...
            <div class="content_dragg">
                <div class="taller_span" data-id="<?php echo $sem_talleres['taller_id']; ?>">Taller: <?php echo $sem_talleres['taller']; ?></div>
                ...
                <div class="salon_span" data-id="<?php echo $sem_talleres['salon_id'] ?>">Sal&oacute;n: <?php echo $sem_talleres['salon'] ?></div>
