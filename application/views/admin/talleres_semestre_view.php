...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs" id="sub_menu_pasos">
            <li><a href="<?php echo base_url() ?>admin/talleres" data-name="talleres">Talleres</a></li>
            ...
            <li class="active"><a href="<?php echo base_url() ?>admin/talleres_semestre" data-name="talleres_semestre">Asignaci&oacute;n</a></li>
        </ul>
    </div>
</div>
<div class="row">
                    ...
                    <form class="form-signin form-horizontal" id="taller_semestre_form" action="admin/talleres_semestre/insert">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="taller_select">Taller</label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="salones_select">Sal&oacute;n</label>
                                <div class="controls">
