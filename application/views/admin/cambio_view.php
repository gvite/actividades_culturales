                ...
                <div class="col-md-3">
                    ...
                    ?>" data-id="<?php echo $taller['id'] ?>">
                        ...
                        <div class="panel-body">
                            ...
                            if (!$taller['puede_mas']) {
                                ?>
                                <span class="label label-warning">* Ya se inscribió este taller</span>
                                <?php
                            }
                            ?>
                        </div>
...
<div class="row">
    <div class="col-md-3 col-md-offset-4">
        <form id="form_cambio" action="admin/cambio/cambiar">
            ...
            <button class="btn btn-primary pull-right" type="submit" id="cambia_taller_button">Cambiar Taller</button>
        </form>
    </div>
</div>