...
<div class="row">
    <div class="col-md-12">
        <ul class="nav nav-tabs" id="sub_menu_pasos">
            <li><a href="<?php echo base_url() ?>admin/talleres.jsp" data-name="talleres">Talleres</a></li>
            ...
            <li class="active"><a href="<?php echo base_url() ?>admin/salones.jsp" data-name="salones">Salones</a></li>
                ...
                <div class="modal-content">
                    <form class="form-signin form-horizontal" id="salon_form" action="admin/salones/insert">
                        <div class="modal-header">
                            ...
                            <h3>Agregar Sal&oacute;n</h3>
                        </div>
                        <div class="modal-body">
                            <div class="control-group">
                                <label class="control-label" for="nombre_input">Sal&oacute;n</label>
                                <div class="controls">
